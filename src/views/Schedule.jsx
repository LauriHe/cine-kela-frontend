...
function Schedule() {
  ...
  return (
    <Fragment>
      <div>
        <div className=" flex flex-col xl:h-screen bg-oc-space-blue items-center">
          <div className=" flex flex-col h-1/6 justify-center xs:my-4 sm:my-4">
            <h1 className=" text-oc-cold-white font-bold text-5xl flex justify-center text-center font-IM-Fell-English-SC">Ciné Kela</h1>
            <h1 className=" text-oc-cold-white font-bold text-3xl text-center">11.10.2023 - {movies[5].premiereDate}</h1>
          </div>
          <div className="flex flex-col xl:flex-row w-full h-full lg:h-4/6 md:w-[750px] xl:w-5/6 bg-oc-space-blue rounded-md gap-4 xl:gap-0 py-4">
            <div className=" card flex flex-col flex-1 grow shrink hover:grow-[10] h-full items-center rounded-md lg:px-2 md:px-2 bg-oc-space-blue">
              ...
              <div className=" flex flex-col justify-center h-full items-center w-full bg-oc-cold-white rounded-b-md hover:rounded-md cardImg">
                <video src="/placeholder.mp4" muted loop></video>
                <div className=" w-full flex flex-col">
                  <h2 className=" text-oc-cold-white text-xl  font-semibold py-2 bg-oc-pastel-blue w-full text-center">Stream</h2>
                  <h2 className=" text-oc-cold-white font-semibold py-2 bg-oc-pastel-blue w-full text-center">To be announced</h2>
                </div>
                <h3 className=" w-full bg-oc-hover-pink font-semibold pl-4">Drama</h3>
                <p className=" text-lg font-medium text-oc-space-blue p-4 bg-oc-cold-white h-full w-full">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore necessitatibus tenetur nam, placeat magnam est, nulla quaerat at,
                  recusandae esse aspernatur unde itaque quas alias omnis sit laudantium neque? Eum?
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className=" flex flex-col justify-center h-full items-center w-full bg-oc-cold-white rounded-b-md hover:rounded-md cardImg2">
                <video id="vid1" src="./movies/Democompo_trailer.mp4" muted loop></video>
                <div className=" w-full flex flex-col">
                  <h2 className=" text-oc-cold-white text-xl  font-semibold py-2 bg-oc-pastel-blue w-full text-center">Democompo</h2>
                ...
                <h3 className=" w-full bg-oc-hover-pink font-semibold pl-4">Horror, Comedy</h3>
                <p className=" text-lg font-medium text-oc-space-blue p-4 bg-oc-cold-white h-full w-full ">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore necessitatibus tenetur nam, placeat magnam est, nulla quaerat at,
                  recusandae esse aspernatur unde itaque quas alias omnis sit laudantium neque? Eum?
                </p>
            ...
            >
              ...
              <div className=" flex flex-col justify-center h-full items-center w-full bg-oc-cold-white rounded-b-md cardImg3">
                <video id="vid2" src="./movies/Mikko_EVTEKtoAlaska_trailer.mp4" loop muted></video>
                <div className=" w-full flex flex-col">
                  <h2 className=" text-oc-cold-white text-xl font-semibold py-2 bg-oc-pastel-blue w-full text-center">Evtek to Alaska</h2>
                  <h2 className=" text-oc-cold-white font-semibold py-2 bg-oc-pastel-blue w-full text-center">
                    {movies[2].premiereTime} - {movies[2].expireTime}
                  </h2>
                </div>
                <h3 className=" w-full bg-oc-hover-pink font-semibold pl-4">Drama, Fantasy, Horror, Thriller</h3>
                <p className=" text-lg font-medium text-oc-space-blue p-4 bg-oc-cold-white h-full w-full ">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore necessitatibus tenetur nam, placeat magnam est, nulla quaerat at,
                  recusandae esse aspernatur unde itaque quas alias omnis sit laudantium neque? Eum?
                </p>
            ...
            >
              ...
              <div className=" flex flex-col justify-center h-full items-center w-full bg-oc-cold-white rounded-b-md hover:rounded-md cardImg4">
                <video id="vid3" src="./movies/Morning_after_trailer.mp4" loop muted></video>
                <div className=" w-full flex flex-col">
                  <h2 className=" text-oc-cold-white text-xl font-semibold py-2 bg-oc-pastel-blue w-full text-center">Morning After</h2>
                  <h2 className=" text-oc-cold-white font-semibold py-2 bg-oc-pastel-blue w-full text-center">
                    {movies[3].premiereTime} - {movies[3].expireTime}
                  </h2>
                </div>
                <h3 className=" w-full bg-oc-hover-pink font-semibold pl-4">Drama, Music, Horror, Comedy</h3>
                <p className=" text-lg font-medium text-oc-space-blue p-4 bg-oc-cold-white h-full w-full ">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore necessitatibus tenetur nam, placeat magnam est, nulla quaerat at,
                  recusandae esse aspernatur unde itaque quas alias omnis sit laudantium neque? Eum?
                </p>
            ...
            >
              ...
              <div className=" flex flex-col justify-center h-full items-center w-full bg-oc-cold-white rounded-b-md hover:rounded-md cardImg5">
                <video id="vid4" src="./movies/Museo_olohuoneena_trailer.mp4" loop muted></video>
                <div className=" w-full flex flex-col">
                  <h2 className=" text-oc-cold-white text-xl  font-semibold py-2 bg-oc-pastel-blue w-full text-center">Museo Olohuoneena</h2>
                  <h2 className=" text-oc-cold-white font-semibold py-2 bg-oc-pastel-blue w-full text-center">
            ...
            >
              ...
              <div className=" flex flex-col justify-center h-full items-center w-full bg-oc-cold-white rounded-b-md hover:rounded-md cardImg6">
                <video id="vid5" src="./movies/Opiskelijaelämää_2009_trailer.mp4" loop muted></video>
                <div className=" w-full flex flex-col">
                  <h2 className=" text-oc-cold-white text-xl font-semibold py-2 bg-oc-pastel-blue w-full text-center">Opiskelijaelamaa 2009</h2>
                  <h2 className=" text-oc-cold-white font-semibold py-2 bg-oc-pastel-blue w-full text-center">
      ...
      {showModal && <TicketForm setShowModal={setShowModal} blurBackground={true} />}
    </Fragment>
  );
}
