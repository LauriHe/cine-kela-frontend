  ...
  return (
    <div className=" flex h-screen bg-oc-desert-yellow justify-center items-center">
      <div className="flex xs:flex-col sm:flex-col lg:flex-row xs:w-screen sm:w-screen xs:h-screen sm:h-screen lg:h-4/6 lg:w-5/6 bg-oc-space-blue rounded-md">
        <div className=" card flex flex-col flex-1 bg-oc-hover-pink grow shrink xs:hover:grow-[10] sm:hover:grow-[20] lg:hover:grow-[10] lg:h-full rounded-l-md items-center">
        ...
        <div className=" card flex flex-col flex-1 bg-oc-hover-pink grow shrink  hover:grow-[10] h-full items-center">
          <h1 className=" px-4 text-3xl font-semibold text-oc-desert-yellow">
            Wednesday
          </h1>
          <div className=" flex flex-col justify-center h-full items-center">
            <video src="./public/fuji.mp4" className=" lg:h-5/6 p-4"></video>
