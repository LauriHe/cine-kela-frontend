        ...
        <div className="w-full lg:w-10/12 m-auto">
          <section className="bg-oc-pastel-blue flex flex-col items-center py-8 my-8 roundedn-none lg:rounded-md">
            ...
            <div className="px-8 w-11/12">
              ...
              <div className="relative">
                <div className={info1 ? 'flex hover:text-oc-rosy-pink liisa' : 'flex hover:text-oc-rosy-pink pekka'} onClick={toggleInfo1}>
                  <h1 className="text-xl font-bold py-4">Question 1</h1>
                  <button className={info1 ? 'infoPlus bg-[url(./minus.svg)]' : 'infoPlus'}></button>
                </div>

                {info1 && (
                  <p className="text-base">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laborum, quam eaque quidem totam molestiae, odio eum qui sunt culpa
                    laudantium provident dolorem? Modi quos maxime id veniam aut iste beatae.
                  </p>
                )}
              </div>
              <hr className="my-8"></hr>
              <div className="relative">
                <div className={info2 ? 'flex hover:text-oc-rosy-pink liisa' : 'flex hover:text-oc-rosy-pink pekka'} onClick={toggleInfo2}>
                  <h1 className="text-xl font-bold py-4">Question 2</h1>
                  <button className={info2 ? 'infoPlus bg-[url(./minus.svg)]' : 'infoPlus'}></button>
                </div>
              ...
              <hr className="my-8"></hr>
              <div className="relative">
                <div className={info3 ? 'flex hover:text-oc-rosy-pink liisa' : 'flex hover:text-oc-rosy-pink pekka'} onClick={toggleInfo3}>
                  <h1 className="text-xl font-bold py-4">Question 3</h1>
                  <button className={info3 ? 'infoPlus bg-[url(./minus.svg)]' : 'infoPlus'}></button>
                </div>
          ...
          <section className="bg-oc-pastel-blue flex flex-col items-center py-8 my-8 roundedn-none lg:rounded-md">
            ...
            <form className="w-full max-w-lg">
              ...
              {/* second row */}
              <div className="mb-4">
                <h2 className="block tracking-wide text-white text-xl mb-2">Are you</h2>
                <input type="radio" id="private" name="person"></input>
                <label htmlFor="private" className="tracking-wide text-white mb-2 mr-8">
                  Private
                </label>
                <input type="radio" id="company" name="person"></input>
                <label htmlFor="company" className="tracking-wide text-white mb-2">
                  Business
                </label>
              </div>
              {/* third row */}
              <div>
                <h2 className="block tracking-wide text-white text-xl mb-2">Summary of your inquiry</h2>
